...
public class BuildingSyntacticSequencer extends AbstractSyntacticSequencer {

	protected BuildingGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (BuildingGrammarAccess) access;
